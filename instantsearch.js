...
!(function (e, t) {
  ...
  (S.PARAMETERS = Object.keys(new S())),
    (S._parseNumbers = function (i) {
      ...
      var r = {};
      if (
        (['aroundPrecision', 'aroundRadius', 'getRankingInfo', 'minWordSizefor2Typos', 'minWordSizefor1Typo', 'page', 'maxValuesPerFacet', 'distinct', 'minimumAroundRadius', 'hitsPerPage', 'minProximity'].forEach(function (e) {
          var t = i[e];
          if ('string' == typeof t) {
            var n = parseFloat(t);
            r[e] = isNaN(n) ? t : n;
    ...
    (S.prototype = {
      ...
      toggleHierarchicalFacetRefinement: function (e, t) {
        ...
        var n = this._getHierarchicalFacetSeparator(this.getHierarchicalFacetByName(e)),
          r = {};
        return (
          void 0 !== this.hierarchicalFacetsRefinements[e] && 0 < this.hierarchicalFacetsRefinements[e].length && (this.hierarchicalFacetsRefinements[e][0] === t || 0 === this.hierarchicalFacetsRefinements[e][0].indexOf(t + n))
            ? -1 === t.indexOf(n)
              ? (r[e] = [])
              : (r[e] = [t.slice(0, t.lastIndexOf(n))])
            : (r[e] = [t]),
          this.setQueryParameters({ hierarchicalFacetsRefinements: m({}, r, this.hierarchicalFacetsRefinements) })
        );
      },
    ...
    M = function (h) {
      return function (e, t) {
        var n = h.hierarchicalFacets[t],
                ...
                var s = Object.keys(n.data)
                  ...
                  .filter(function (e) {
                    return (function (e, t, n, r, i, a) {
                      return (
                        (!i || (0 === e.indexOf(i) && i !== e)) &&
                        ((!i && -1 === e.indexOf(r)) || (i && e.split(r).length - i.split(r).length == 1) || (-1 === e.indexOf(r) && -1 === n.indexOf(r)) || 0 === n.indexOf(e) || (0 === e.indexOf(t + r) && (a || 0 === e.indexOf(n))))
                      );
                ...
                r.data = F(
                  s.map(function (e) {
                    ...
                    return (function (e, t, n, r, i) {
                      var a = t.split(n);
                      return { name: a[a.length - 1].trim(), path: t, count: e, isRefined: r === t || 0 === r.indexOf(t + n), exhaustive: i, data: null };
          ...
          l = e;
        return a && (l = e.slice(a.split(i).length)), l.reduce(u, { name: h.hierarchicalFacets[t].name, count: null, isRefined: !0, path: null, exhaustive: c, data: null });
      };
    };
  function I(e) {
    var n = {};
  ...
  function H(l, n) {
    ...
    Object.keys(d).forEach(function (e) {
      ...
      if (n) {
        ...
        s && ((a = h[e]), (f.disjunctiveFacets[a] = { name: e, data: t, exhaustive: c.exhaustiveFacetsCount }), L(f.disjunctiveFacets[a], c.facets_stats, e)),
          o && ((a = u[e]), (f.facets[a] = { name: e, data: t, exhaustive: c.exhaustiveFacetsCount }), L(f.facets[a], c.facets_stats, e));
      }
    }),
      ...
      e.forEach(function (e) {
        ...
        Object.keys(s).forEach(function (t) {
          ...
          if (o) {
            ...
            (f.disjunctiveFacets[n] = { name: t, data: m({}, e, i), exhaustive: a.exhaustiveFacetsCount }),
      ...
      (this.hierarchicalFacets = this.hierarchicalFacets.map(M(l))),
  ...
  ((W.EventEmitter = W).prototype._events = void 0),
    ...
    (W.prototype.on = W.prototype.addListener =
      function (e, t) {
        ...
        return (
          ...
          this._events[e] ? (z(this._events[e]) ? this._events[e].push(t) : (this._events[e] = [this._events[e], t])) : (this._events[e] = t),
          z(this._events[e]) &&
    ...
    (W.prototype.removeListener = function (e, t) {
      ...
      if (((i = (n = this._events[e]).length), (r = -1), n === t || ($(n.listener) && n.listener === t))) delete this._events[e], this._events.removeListener && this.emit('removeListener', e, t);
      else if (z(n)) {
        for (a = i; 0 < a--; )
  ...
  var G = J,
    X = {
      _getQueries: function (i, a) {
        var s = [];
        return (
          s.push({ indexName: i, params: X._getHitsSearchParams(a) }),
          ...
          a.getRefinedHierarchicalFacets().forEach(function (e) {
            ...
            0 < n.length && 1 < n[0].split(r).length && s.push({ indexName: i, params: X._getDisjunctiveFacetSearchParams(a, e, !0) });
          }),
          s
        );
      },
      _getHitsSearchParams: function (e) {
        var t = e.facets.concat(e.disjunctiveFacets).concat(X._getHitsHierarchicalFacetsAttributes(e)),
          n = X._getFacetFilters(e),
          r = X._getNumericFilters(e),
      ...
      _getDisjunctiveFacetSearchParams: function (e, t, n) {
        var r = X._getFacetFilters(e, t, n),
          i = X._getNumericFilters(e, t),
          a = { hitsPerPage: 1, page: 0, attributesToRetrieve: [], attributesToHighlight: [], attributesToSnippet: [], tagFilters: X._getTagFilters(e), analytics: !1, clickAnalytics: !1 },
    ...
    ee = '0.0.0-5a0352a';
  function te(e, t, n) {
    'function' == typeof e.addAlgoliaAgent && e.addAlgoliaAgent('JS Helper (' + ee + ')'), this.setClient(e);
    var r = n || {};
  ...
  Y(te, e.EventEmitter),
    ...
    (te.prototype.searchOnce = function (e, t) {
      ...
      if ((this._currentNbQueries++, this.emit('searchOnce', { state: n }), !t))
        return this.client.search(r).then(
          function (e) {
            return i._currentNbQueries--, 0 === i._currentNbQueries && i.emit('searchQueueEmpty'), { content: new V(n, e.results), state: n, _originalResponse: e };
          },
          function (e) {
    ...
    (te.prototype.searchForFacetValues = function (t, e, n, r) {
      ...
      return (
        ...
        (i ? this.client.searchForFacetValues([{ indexName: a.index, params: o }]) : this.client.initIndex(a.index).searchForFacetValues(o)).then(
          function (e) {
            return (
              c._currentNbQueries--,
    ...
    (te.prototype.hasRefinements = function (e) {
      return (
        ...
        (this.state.isConjunctiveFacet(e) ? this.state.isFacetRefined(e) : this.state.isDisjunctiveFacet(e) ? this.state.isDisjunctiveFacetRefined(e) : !!this.state.isHierarchicalFacet(e) && this.state.isHierarchicalFacetRefined(e))
      );
    }),
    ...
    (te.prototype._search = function (e) {
      var r = this.state,
        i = [],
        t = [];
      e.onlyWithDerivedHelpers || ((t = Z._getQueries(r.index, r)), i.push({ state: r, queriesCount: t.length, helper: this }), this.emit('search', { state: r, results: this.lastResults }));
      var n = this.derivedHelpers.map(function (e) {
          var t = e.getModifiedState(r),
            n = Z._getQueries(t.index, t);
          return i.push({ state: t, queriesCount: n.length, helper: e }), e.emit('search', { state: t, results: e.lastResults }), n;
        }),
    ...
    (te.prototype.setClient = function (e) {
      return this.client === e || ('function' == typeof e.addAlgoliaAgent && e.addAlgoliaAgent('JS Helper (' + ee + ')'), (this.client = e)), this;
    }),
  ...
  var pe = me(function (e, t) {
      !(function (R) {
        ...
        (R.tags = { '#': 1, '^': 2, '<': 3, $: 4, '/': 5, '!': 6, '>': 7, '=': 8, _v: 9, '{': 10, '&': 11, _t: 12 }),
          (R.scan = function (e, t) {
            var n,
              r,
              i,
            ...
            function b(e, t) {
              if (
                ...
                for (var n, r = p; r < f.length; r++) f[r].text && ((n = f[r + 1]) && '>' == n.tag && (n.indent = f[r].text.toString()), f.splice(r, 1));
              else t || f.push({ tag: '\n' });
              (d = !1), (p = f.length);
            }
                ...
                ? ((m += g.length - 1),
                  (c =
                    '=' == (u = (l = R.tags[e.charAt(m + 1)]) ? e.charAt(m + 1) : '_v')
                      ? ((r = m), void 0, (i = '=' + v), (a = (n = e).indexOf(i, r)), (s = P(n.substring(n.indexOf('=', r) + 1, a)).split(' ')), (g = s[0]), (v = s[s.length - 1]), (m = a + i.length - 1), 0)
                      : (l && m++, 2)),
                  (d = m))
                : _(v, e, m)
                ? (f.push({ tag: u, n: P(h), otag: g, ctag: v, i: '/' == u ? d - g.length : m + v.length }), (h = ''), (m += v.length - 1), (c = 0), '{' == u && ('}}' == v ? m++ : S(f[f.length - 1])))
                : (h += e.charAt(m));
            return b(d, !0), f;
          });
        var u = { _t: !0, '\n': !0, $: !0, '/': !0 };
        ...
        function m(e, t) {
          ...
          return (t.partials[n] = { name: e.n, partials: {} }), (t.code += 't.b(t.rp("' + f(n) + '",c,p,"' + (e.indent || '') + '"));'), n;
        }
        function e(e, t) {
  ...
  function Se(n, r, e) {
    ...
    return (
      ...
      t && r.query && r.query.trim() && a.push({ attribute: 'query', type: 'query', name: r.query, query: r.query }),
      a
    );
  }
  function Pe(e) {
  ...
  function ze(e) {
    ...
    return (function n(e) {
      return e.filter(Ve).reduce(function (e, t) {
        return e.concat.apply(e, [{ indexId: t.getIndexId(), results: t.getResults(), helper: t.getHelper() }].concat(w(n(t.getWidgets()))));
      }, []);
    })(t ? t.getWidgets() : [e]);
  }
  function Ke(e) {
    ...
    return {
      ...
      addWidgets: function (e) {
        ...
        return (
          ...
          f &&
            ...
            e.forEach(function (e) {
              f && e.init && e.init({ helper: m, parent: t, uiState: {}, instantSearchInstance: f, state: m.state, templatesConfig: f.templatesConfig, createURL: o });
            }),
            f.scheduleSearch()),
          this
        );
      ...
      removeWidgets: function (t) {
        ...
        if (
          ...
          (h = We(l, { searchParameters: e, helper: m })), m.setState($e(l, { uiState: h, initialSearchParameters: e })), l.length && f.scheduleSearch();
        }
        return this;
      },
      init: function (e) {
        ...
        ((m = se({}, s.index, s)).search = function () {
          ...
          l.forEach(function (e) {
            e.init && e.init({ uiState: i, helper: m, parent: t, instantSearchInstance: n, state: m.state, templatesConfig: n.templatesConfig, createURL: o });
          }),
          m.on('change', function (e) {
            var t = e.state;
      ...
      render: function (e) {
        ...
        l.forEach(function (e) {
          e.render &&
            p.lastResults &&
            e.render({ helper: m, instantSearchInstance: n, results: p.lastResults, scopedResults: ze(t), state: p.lastResults._state, templatesConfig: n.templatesConfig, createURL: o, searchMetadata: { isSearchStalled: n._isSearchStalled } });
        });
      },
      dispose: function () {
        l.forEach(function (e) {
        ...
        },
        {
          ...
          value: function (n) {
            var e = Object.keys(n).reduce(function (e, t) {
              ...
              t = this.stateMapping.stateToRoute(e);
  ...
  function et(e, t, n, r, i, a, s, o, c, u, l, h, f) {
    ...
    if (
      ...
      return a ? [l(h ? t : a(t, bt.encoder, f)) + '=' + l(a(d, bt.encoder, f))] : [l(t) + '=' + l(String(d))];
    var m,
      p = [];
      ...
      encode: function (e, t, n) {
        ...
        for (var i = '', a = 0; a < r.length; ++a) {
          ...
          45 === s || 46 === s || 95 === s || 126 === s || (48 <= s && s <= 57) || (65 <= s && s <= 90) || (97 <= s && s <= 122)
            ...
            ? (i += ot[s])
            : s < 2048
            ? (i += ot[192 | (s >> 6)] + ot[128 | (63 & s)])
            : s < 55296 || 57344 <= s
            ? (i += ot[224 | (s >> 12)] + ot[128 | ((s >> 6) & 63)] + ot[128 | (63 & s)])
            : ((a += 1), (s = 65536 + (((1023 & s) << 10) | (1023 & r.charCodeAt(a)))), (i += ot[240 | (s >> 18)] + ot[128 | ((s >> 12) & 63)] + ot[128 | ((s >> 6) & 63)] + ot[128 | (63 & s)]));
        }
        return i;
      },
      isBuffer: function (e) {
                    ...
                    for (n = 0; n < s.length; ++n)
                      if (n !== o) {
                        var u,
                          ...
                          f = h.indexOf(']='),
                          d = -1 === f ? h.indexOf('=') : f + 1;
                        (l = -1 === d ? ((u = t.decoder(h, wt.decoder, c)), t.strictNullHandling ? null : '') : ((u = t.decoder(h.slice(0, d), wt.decoder, c)), t.decoder(h.slice(d + 1), wt.decoder, c))) &&
                          ...
                          Rt.call(r, u) ? (r[u] = ct.combine(r[u], l)) : (r[u] = l);
                      }
                    return r;
                  })(e, n)
                : e,
      ...
      stringify: function (e, t) {
        var n,
          ...
          i = (function (e) {
            ...
            var r = ft.formatters[n],
              i = bt.filter;
            return (
              ('function' != typeof e.filter && !pt(e.filter)) || (i = e.filter),
              {
  ...
  function Ft(e) {
    return (function (e) {
      ...
      .replace(new RegExp(xt.highlightPreTag, 'g'), Nt.highlightPreTag)
      .replace(new RegExp(xt.highlightPostTag, 'g'), Nt.highlightPostTag);
  }
  function Ct(n) {
    return Me(n) && 'string' != typeof n.value
      ? Object.keys(n).reduce(function (e, t) {
          return D({}, e, C({}, t, Ct(n[t])));
        }, {})
      : Array.isArray(n)
      ? n.map(Ct)
      : D({}, n, { value: Ft(n.value) });
  }
  function Mt(e) {
    return (
      void 0 === e.__escaped &&
  ...
  function kt(e) {
    var t = e.attribute,
      ...
      r = void 0 === n ? 'mark' : n,
      i = Ne(e.hit, '_highlightResult.'.concat(t, '.value')) || '',
      a = Lt({ descendantName: 'highlighted' });
  ...
  function jt(e) {
    var t = e.attribute,
      n = e.highlightedTagName,
      r = void 0 === n ? 'mark' : n,
      i = Ne(e.hit, '_snippetResult.'.concat(t, '.value')) || '',
      a = Tt({ descendantName: 'highlighted' });
    return i.replace(new RegExp(Nt.highlightPreTag, 'g'), '<'.concat(r, ' class="').concat(a, '">')).replace(new RegExp(Nt.highlightPostTag, 'g'), '</'.concat(r, '>'));
  }
  ...
  var At = (function () {
      function y(e) {
        var t;
        k(this, y),
          C(b((t = A(this, E(y).call(this)))), 'client', void 0),
          C(b(t), 'indexName', void 0),
          C(b(t), 'insightsClient', void 0),
          C(b(t), 'helper', void 0),
          C(b(t), 'mainHelper', void 0),
          C(b(t), 'mainIndex', void 0),
          C(b(t), 'started', void 0),
          C(b(t), 'templatesConfig', void 0),
          C(b(t), '_stalledSearchDelay', void 0),
          C(b(t), '_searchStalledTimer', void 0),
          C(b(t), '_isSearchStalled', void 0),
          C(b(t), '_initialUiState', void 0),
          C(b(t), '_createURL', void 0),
          C(b(t), '_searchFunction', void 0),
          C(b(t), '_mainHelperSearch', void 0),
          C(b(t), '_routingManager', void 0),
          C(
            b(t),
            'scheduleSearch',
            oe(function () {
        ...
        if (('function' == typeof d.addAlgoliaAgent && d.addAlgoliaAgent('instantsearch.js ('.concat('4.0.0', ')')), p && 'function' != typeof p)) throw new Error(Et('The `insightsClient` option should be a function.'));
        (t.client = d),
          (t.insightsClient = p),
          (t.indexName = r),
          (t.helper = null),
          (t.mainHelper = null),
          (t.mainIndex = Ke({ indexName: r })),
          (t.started = !1),
          (t.templatesConfig = {
            helpers: (function (e) {
          ...
          (t._stalledSearchDelay = h),
          (t._searchStalledTimer = null),
          (t._isSearchStalled = !1),
          (t._createURL = Ot),
          (t._initialUiState = s),
          u && (t._searchFunction = u);
        var g = { stateMapping: Ge(), router: _t() },
          v = null;
        return (
          !0 === c ? (v = g) : Me(c) && (v = D({}, g, {}, c)),
          v && ((t._routingManager = new Ye(D({}, v, { instantSearchInstance: b(t) }))), (t._createURL = t._routingManager.createURL), (t._initialUiState = D({}, s, {}, t._routingManager.read()))),
          t
        );
      }
      return (
          ...
          },
          {
            ...
            value: function () {
              ...
              t.on('error', function (e) {
                ...
                this._routingManager && this._routingManager.subscribe(),
                t.search(),
          ...
          },
          {
            ...
            value: function () {
              this.scheduleSearch.cancel(),
                ...
                (this.helper = null),
                this._routingManager && this._routingManager.dispose();
            },
          },
          {
          ...
          render: function (e) {
            var t,
              ...
              s = n.reduce(function (e, t) {
                return e.concat(h(Ut({ results: t.results, helper: t.helper, includedAttributes: u, excludedAttributes: l })));
              }, []);
            function o(e) {
              return t.apply(this, arguments);
            }
      ...
      function () {
        ...
        return {
          ...
          _prepareFacetValues: function (e, i) {
            ...
            return e.slice(0, this.getLimit()).map(function (e) {
              var t = e.name,
                n = e.path,
                r = O(e, ['name', 'path']);
              return Array.isArray(r.data) && (r.data = a._prepareFacetValues(r.data, i)), D({}, r, { label: t, value: n });
            });
          },
          render: function (e) {
            var t = e.results,
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            var i = e.removeHierarchicalFacet(y).addHierarchicalFacet({ name: y, attributes: c, separator: u, rootPath: h, showParentLevel: f }),
      ...
      function () {
        ...
        return {
          ...
          render: function (e) {
            ...
            (t.hits = Qe(t.hits, t.page, t.hitsPerPage)), (t.hits = Ue(t.hits, t.queryID)), (t.hits = s(t.hits)), (t.hits.__escaped = r), o({ hits: t.hits, results: t, instantSearchInstance: n, widgetParams: i }, !1);
          },
          dispose: function (e) {
            var t = e.state;
            return (
              ...
              a
                ? t.setQueryParameters(
                    Object.keys(xt).reduce(function (e, t) {
  ...
  function hn(e, t, n, r) {
    var i = { type: e, props: t, key: n, ref: r, __k: null, __p: null, __b: 0, __e: null, l: null, __c: null, constructor: void 0 };
  ...
  function vn() {
    ...
    for (
      ...
      e.__d && ((r = n = void 0), (a = (i = (t = e).__v).__e), (s = t.__P), (o = t.u), (t.u = !1), s && ((n = []), (r = Pn(s, i, cn({}, i), t.__n, void 0 !== s.ownerSVGElement, null, n, o, null == a ? mn(i) : a)), _n(n, i), r != a && pn(i)));
  }
  ...
  function wn(e, t, n, r, i) {
    ...
    if ('key' === (t = i ? ('className' === t ? 'class' : t) : 'class' === t ? 'className' : t) || 'children' === t);
      ...
      'o' === t[0] && 'n' === t[1]
        ? ((c = t !== (t = t.replace(/Capture$/, ''))), (t = ((u = t.toLowerCase()) in e ? u : t).slice(2)), n ? (r || e.addEventListener(t, Sn, c), ((e.t || (e.t = {}))[t] = n)) : e.removeEventListener(t, Sn, c))
      ...
      e: if ('function' == typeof R) {
        if (
          ...
          n.__c
            ...
            : ('prototype' in R && R.prototype.render ? (t.__c = h = new R(v, b)) : ((t.__c = h = new dn(v, b)), (h.constructor = R), (h.render = Fn)),
              y && y.sub(h),
              (h.props = v),
              h.state || (h.state = {}),
              (h.context = b),
          ...
          null != R.getDerivedStateFromProps && cn(h.__s == h.state ? (h.__s = cn({}, h.__s)) : h.__s, R.getDerivedStateFromProps(v, h.__s)),
          f)
        )
          null == R.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), null != h.componentDidMount && s.push(h);
        else {
          ...
          return (
            null === t.type
              ...
              : t !== n &&
                ...
                o || ((h || l) && ((h && l && h.__html == l.__html) || (e.innerHTML = (h && h.__html) || ''))),
                (function (e, t, n, r, i) {
                  var a;
                ...
                o || ('value' in d && void 0 !== d.value && d.value !== e.value && (e.value = null == d.value ? '' : d.value), 'checked' in d && void 0 !== d.checked && d.checked !== e.checked && (e.checked = d.checked))),
            e
          );
        })(n.__e, t, n, r, i, a, s, u);
      (l = Zt.diffed) && l(t);
  ...
  function Cn(e, t, n) {
    ...
    Zt.__p && Zt.__p(e, t),
      ...
      (e = ln(fn, null, [e])),
      (a = []),
      Pn(t, r ? (t.__k = e) : ((n || t).__k = e), i || an, an, void 0 !== t.ownerSVGElement, n && !r ? [n] : i ? null : sn.slice.call(t.childNodes), a, !1, n || an, r),
      _n(a, e);
  }
  (Zt = {}),
    ...
    (en = []),
    (tn = 'function' == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
        ...
        return {
          ...
          init: function (e) {
            ...
            o.some(function (e) {
              ...
              c({ items: s(this._normalizeItems(r)), refine: this.setHitsPerPage, createURL: this.createURL(t.state), hasNoResults: !0, widgetParams: a, instantSearchInstance: i }, !0);
          },
          render: function (e) {
            var t = e.state,
              n = e.results,
              r = e.instantSearchInstance,
              i = 0 === n.nbHits;
            c({ items: s(this._normalizeItems(t)), refine: this.setHitsPerPage, createURL: this.createURL(t), hasNoResults: i, widgetParams: a, instantSearchInstance: r }, !1);
          },
        ...
        return {
          ...
          init: function (e) {
            ...
            (d = (function (e) {
              ...
              (y = n.state.page || 0),
              (b = n.state.page || 0),
              R({ hits: v, results: void 0, showPrevious: d, showMore: m, isFirstPage: 0 === y, isLastPage: !0, instantSearchInstance: t, widgetParams: l }, !0);
          },
          render: function (e) {
            var t = e.results,
              n = e.state,
            ...
            (s.facetsRefinements = h(s.facetsRefinements)),
              ...
              ke(s, f) || ((v = []), (b = y = a), (f = s)),
              p && 0 < t.hits.length && (t.hits = Mt(t.hits));
            var o = t.hits.__escaped;
            (t.hits = Qe(t.hits, t.page, t.hitsPerPage)),
              (t.hits = Ue(t.hits, t.queryID)),
              (t.hits = g(t.hits)),
              (t.hits.__escaped = o),
              b < a || !v.length ? ((v = [].concat(w(v), w(t.hits))), (b = a)) : a < y && ((v = [].concat(w(t.hits), w(v))), (y = a));
            var c = 0 === y,
              u = t.nbPages <= t.page + 1;
            R({ hits: v, results: t, showPrevious: d, showMore: m, isFirstPage: c, isLastPage: u, instantSearchInstance: r, widgetParams: l }, !1);
          },
          dispose: function (e) {
            var t = e.state;
            a();
        ...
        return {
          ...
          init: function (e) {
            ...
            (this.cachedToggleShowMore = this.cachedToggleShowMore.bind(this)),
              ...
              d({ items: [], createURL: this._createURL, refine: this._refine, instantSearchInstance: r, canRefine: !1, widgetParams: s, isShowingMore: this.isShowingMore, toggleShowMore: this.cachedToggleShowMore, canToggleShowMore: !1 }, !0);
          },
          render: function (e) {
            var t = e.results,
              n = e.instantSearchInstance,
            ...
            (this.toggleShowMore = this.createToggleShowMore({ results: t, instantSearchInstance: n })),
              d(
                {
                  items: a,
        ...
        function o(i) {
          return r.map(function (e) {
            var t = e.start,
              n = e.end,
              r = e.label;
            return { label: r, value: window.encodeURI(JSON.stringify({ start: t, end: n })), isRefined: Bn(i, u, { start: t, end: n, label: r }) };
          });
        }
        var c = {};
        return {
          ...
          init: function (e) {
            ...
            (c.refine = function (e) {
              ...
              l({ createURL: c.createURL(n.state), items: s(o(n.state)), hasNoResults: !0, refine: c.refine, instantSearchInstance: t, widgetParams: i }, !0);
          },
          render: function (e) {
            var t = e.results,
              n = e.state,
              r = e.instantSearchInstance;
            l({ createURL: c.createURL(n), items: s(o(n)), hasNoResults: 0 === t.nbHits, refine: c.refine, instantSearchInstance: r, widgetParams: i }, !1);
          },
          dispose: function (e) {
            var t = e.state;
  ...
  function Qn(e, t, n) {
    ...
    return (
      void 0 !== i.start && (r = Un(a, '>=', i.start) ? r.removeNumericRefinement(t, '>=', i.start) : r.addNumericRefinement(t, '>=', i.start)),
      void 0 !== i.end && (r = Un(a, '<=', i.end) ? r.removeNumericRefinement(t, '<=', i.end) : r.addNumericRefinement(t, '<=', i.end)),
    ...
    return (
      ...
      function () {
        var s = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
          n = s.totalPages,
          e = s.padding,
          o = new qn({ currentPage: 0, total: 0, padding: void 0 === e ? 3 : e });
        return {
          $$type: 'ais.pagination',
          init: function (e) {
            var t = e.helper,
            ...
            (this.refine = function (e) {
              ...
              c({ createURL: this.createURL(t.state), currentRefinement: t.state.page || 0, nbHits: 0, nbPages: 0, pages: [], isFirstPage: !0, isLastPage: !0, refine: this.refine, widgetParams: s, instantSearchInstance: r }, !0);
          },
          ...
          render: function (e) {
            ...
            (o.currentPage = i),
              (o.total = a),
              c({ createURL: this.createURL(n), currentRefinement: i, refine: this.refine, nbHits: t.nbHits, nbPages: a, pages: o.pages(), isFirstPage: o.isFirstPage(), isLastPage: o.isLastPage(), widgetParams: s, instantSearchInstance: r }, !1);
          },
          dispose: function (e) {
            var t = e.state;
        ...
        return {
          ...
          _getCurrentRange: function (e) {
            var t,
              n,
              r = Math.pow(10, u);
            return (t = x ? P : Ce(e.min) ? e.min : 0), (n = N ? _ : Ce(e.max) ? e.max : 0), { min: Math.floor(t * r) / r, max: Math.ceil(n * r) / r };
          },
          ...
          init: function (e) {
            ...
            h({ refine: this._refine(t, {}), format: l, range: r, widgetParams: D({}, c, { precision: u }), start: i, instantSearchInstance: n }, !0);
          },
          render: function (e) {
            var t = e.results,
              n = e.helper,
            ...
            h({ refine: this._refine(n, s), format: l, range: s, widgetParams: D({}, c, { precision: u }), start: o, instantSearchInstance: r }, !1);
          },
          dispose: function (e) {
            var t = e.state;
            r();
      ...
      function () {
        ...
        function o(n, u) {
          return function (r, i, a, s, o, c) {
            return function (e) {
              if ('' === e && P) R({ items: P, state: r, createURL: i, helperSpecializedSearchFacetValues: a, refine: s, isFromSearch: !1, isFirstSearch: !1, instantSearchInstance: o, toggleShowMore: u, isShowingMore: c });
              else {
                var t = { highlightPreTag: l ? xt.highlightPreTag : Nt.highlightPreTag, highlightPostTag: l ? xt.highlightPostTag : Nt.highlightPostTag };
                n.searchForFacetValues(m, e, b(c), t).then(function (e) {
                  ...
                  R({ items: n, state: r, createURL: i, helperSpecializedSearchFacetValues: a, refine: s, isFromSearch: !0, isFirstSearch: !1, instantSearchInstance: o, isShowingMore: c });
                });
              }
            };
          };
        ...
        return {
          ...
          render: function (e) {
            ...
            (_ = c < o ? a.length <= c : a.length < c),
              (P = s),
              (this.toggleShowMore = this.createToggleShowMore(e)),
              R({ items: s, state: n, createURL: r, helperSpecializedSearchFacetValues: w, refine: S, isFromSearch: !1, isFirstSearch: !1, instantSearchInstance: i, isShowingMore: this.isShowingMore, toggleShowMore: this.cachedToggleShowMore });
          },
          dispose: function (e) {
            var t = e.state;
            c();
        ...
        return {
          ...
          init: function (e) {
            ...
            (this._refine = function (e) {
              ...
              o({ query: t.state.query || '', refine: this._refine, clear: this._cachedClear, widgetParams: i, instantSearchInstance: n }, !0);
          },
          render: function (e) {
            var t = e.helper,
              n = e.instantSearchInstance,
              r = e.searchMetadata;
            (this._clear = s(t)), o({ query: t.state.query || '', refine: this._refine, clear: this._cachedClear, widgetParams: i, instantSearchInstance: n, isSearchStalled: r.isSearchStalled }, !1);
          },
          dispose: function (e) {
            var t = e.state;
        ...
        return {
          ...
          init: function (e) {
            ...
            (this.initialIndex = r.getIndexName()),
              ...
              c({ currentRefinement: i, options: o(s), refine: this.setIndex, hasNoResults: !0, widgetParams: a, instantSearchInstance: n }, !0);
          },
          render: function (e) {
            var t = e.helper,
              n = e.results,
              r = e.instantSearchInstance;
            c({ currentRefinement: t.state.index, options: o(s), refine: this.setIndex, hasNoResults: 0 === n.nbHits, widgetParams: a, instantSearchInstance: r }, !1);
          },
          dispose: function (e) {
            var t = e.state;
        ...
        return {
          ...
          init: function (e) {
            ...
            (this._toggleRefinement = this._toggleRefinement.bind(this, t)),
              ...
              g({ instantSearchInstance: r, items: [], hasNoResults: !0, refine: this._toggleRefinement, createURL: this._createURL(t.state), widgetParams: d }, !0);
          },
          render: function (e) {
            ...
            g({ instantSearchInstance: i, items: a, hasNoResults: 0 === n.nbHits, refine: this._toggleRefinement, createURL: this._createURL(r), widgetParams: d }, !1);
          },
          dispose: function (e) {
            var t = e.state;
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            return r
              ? Ie({ start: Number(r), end: p + 1 }).reduce(function (e, t) {
                  return e.addDisjunctiveFacetRefinement(m, t);
                }, i)
              : i.setQueryParameters({ disjunctiveFacetsRefinements: D({}, i.disjunctiveFacetsRefinements, C({}, m, [])) });
          },
      ...
      function () {
        ...
        return {
          ...
          init: function (e) {
            var t = e.helper,
              n = e.instantSearchInstance;
            i({ instantSearchInstance: n, hitsPerPage: t.state.hitsPerPage, nbHits: 0, nbPages: 0, page: t.state.page || 0, processingTimeMS: -1, query: t.state.query || '', widgetParams: r }, !0);
          },
          render: function (e) {
            var t = e.results,
              n = e.instantSearchInstance;
            i({ instantSearchInstance: n, hitsPerPage: t.hitsPerPage, nbHits: t.nbHits, nbPages: t.nbPages, page: t.page, processingTimeMS: t.processingTimeMS, query: t.query, widgetParams: r }, !1);
          },
          dispose: function () {
            e();
          },
    ...
    return (
      ...
      function () {
        ...
        return {
          ...
          _toggleRefinement: function (e, t) {
            (1 < arguments.length && void 0 !== t ? t : {}).isRefined ? (e.removeDisjunctiveFacetRefinement(m, g), p && e.addDisjunctiveFacetRefinement(m, v)) : (p && e.removeDisjunctiveFacetRefinement(m, v), e.addDisjunctiveFacetRefinement(m, g)),
              e.search();
          },
          init: function (e) {
            var t = this,
            ...
            var c = { name: m, isRefined: s, count: null, onFacetValue: { isRefined: s, count: 0 }, offFacetValue: { isRefined: p && !s, count: 0 } };
            y({ value: c, createURL: this._createURL(c.isRefined), refine: this.toggleRefinement, instantSearchInstance: a, widgetParams: d }, !0);
          },
          render: function (e) {
            var t = e.helper,
              n = e.results,
            ...
            y({ value: f, state: r, createURL: this._createURL(f.isRefined), refine: this.toggleRefinement, helper: t, instantSearchInstance: i, widgetParams: d }, !1);
          },
          dispose: function (e) {
            var t = e.state;
        ...
        return {
          ...
          init: function (e) {
            ...
            (this._createURL = function (e) {
              ...
              u({ createURL: this._createURL, canRefine: !1, instantSearchInstance: t, items: [], refine: this._refine, widgetParams: o }, !0);
          },
          render: function (e) {
            var t = e.instantSearchInstance,
              n = e.results,
            ...
            u({ canRefine: 0 < s.length, createURL: this._createURL, instantSearchInstance: t, items: s, refine: this._refine, widgetParams: o }, !1);
          },
          dispose: function () {
            l();
          },
        ...
        var R = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          w =
            void 0 === n
              ...
              : n,
          S = { isRefineOnMapMove: t, hasMapMoveSinceLastRefine: !1, lastRefinePosition: '', lastRefineBoundingBox: '', internalToggleRefineOnMapMove: Fe, internalSetMapMoveSinceLastRefine: Fe };
        return {
          $$type: 'ais.geoSearch',
          init: function (e) {
            var t = e.state,
  ...
  var pr = Ae({ name: 'autocomplete', connector: !0 }),
    gr = Ae({ name: 'query-rules', connector: !0 });
  function vr(e) {
    var t = this.helper,
        ...
        return {
          ...
          init: function (e) {
            var t = e.helper,
              ...
              r = e.instantSearchInstance;
            (h = n.ruleContexts || []),
              (c = vr.bind({ helper: t, initialRuleContexts: h, trackedFilters: i, transformRuleContexts: s })),
              l &&
                (((function (e) {
  ...
  function br(e) {
    ...
    function c(e) {
      i({ status: 'recognizing', transcript: (e.results[0] && e.results[0][0] && e.results[0][0].transcript) || '', isSpeechFinal: e.results[0] && e.results[0].isFinal }), f && v.transcript && m(v.transcript);
    }
    function u() {
    ...
    return {
      ...
      toggleListening: function () {
        n() &&
          (r()
            ? (l(), a('finished'))
            : (h = new g()) && (a('askingPermission'), (h.interimResults = !0), d && (h.lang = d), h.addEventListener('start', s), h.addEventListener('error', o), h.addEventListener('result', c), h.addEventListener('end', u), h.start()));
      },
      dispose: l,
    };
  }
      ...
      function (c) {
        function i(e) {
          var t = e.isFirstRendering,
            ...
            s = r.toggleListening,
            o = r.getState;
          u({ isBrowserSupported: i(), isListening: a(), toggleListening: s, voiceListeningState: o(), widgetParams: c, instantSearchInstance: n }, t);
        }
          ...
          init: function (e) {
            ...
            (this._refine = function (e) {
              if (e !== n.state.query) {
                ...
                n.setQueryParameter('queryLanguages', t), 'function' == typeof o && n.setState(n.state.setQueryParameters(D({ ignorePlurals: !0, removeStopWords: !0, optionalWords: e }, o({ query: e })))), n.setQuery(e).search();
              }
            }),
            ...
            if ('function' == typeof o) {
              var r = o({ query: '' }),
                i = r
                  ...
                  : {};
              n = t.setQueryParameters(D({ queryLanguages: void 0, ignorePlurals: void 0, removeStopWords: void 0, optionalWords: void 0 }, i));
            }
  ...
  var wr = Ae({ name: 'voice-search', connector: !0 }),
    Sr = Object.freeze({
            ...
            return {
              ...
              init: function (e) {
                ...
                (o.refine = function (e) {
                  ...
                  c({ widgetParams: a, currentRefinement: n.state.query || '', indices: [], refine: o.refine, instantSearchInstance: t }, !0);
              },
              render: function (e) {
                var t = e.helper,
                  n = e.scopedResults,
                  r = e.instantSearchInstance,
                  i = n.map(function (e) {
                    return (e.results.hits = s ? Mt(e.results.hits) : e.results.hits), { indexId: e.indexId, indexName: e.results.index, hits: e.results.hits, results: e.results };
                  });
                c({ widgetParams: a, currentRefinement: t.state.query || '', indices: i, refine: o.refine, instantSearchInstance: r }, !1);
              },
              getWidgetState: function (e, t) {
                var n = t.searchParameters.query || '';
                return '' === n || (e && e.query === n) ? e : D({}, e, { query: n });
      ...
      (t.typeOf = b),
        ...
        (t.isValidElementType = function (e) {
          return (
            ...
            e === d ||
            e === m ||
            ('object' == typeof e && null !== e && (e.$$typeof === g || e.$$typeof === p || e.$$typeof === c || e.$$typeof === u || e.$$typeof === f || e.$$typeof === v || e.$$typeof === y))
          );
        }),
  ...
  Pr.typeOf,
    ...
    Pr.StrictMode,
    Pr.Suspense,
    Pr.isValidElementType,
    Pr.isAsyncMode,
    Pr.isConcurrentMode,
    Pr.isContextConsumer,
    Pr.isContextProvider,
    Pr.isElement,
    Pr.isForwardRef,
    Pr.isFragment,
    Pr.isLazy,
          ...
          },
          {
            ...
            value: function () {
              var e = this.props.rootTagName,
                ...
                n = ye({ templates: this.props.templates, templateKey: this.props.templateKey, compileOptions: t, helpers: this.props.templatesConfig.helpers, data: this.props.data });
  ...
  function kr(e) {
    var t = e.hasRefinements,
      ...
      r = e.cssClasses,
      i = e.templateProps;
    return ln('div', { className: r.root }, ln(Lr, f({}, i, { templateKey: 'resetLabel', rootTagName: 'button', rootProps: { className: Ir(r.button, C({}, r.disabledButton, !t)), onClick: n, disabled: !t }, data: { hasRefinements: t } })));
  }
  var Tr = { resetLabel: 'Clear refinements' },
    jr = Ae({ name: 'clear-refinements' }),
    Er = It('ClearRefinements');
  function Or(e) {
    var t = e.items,
      n = e.cssClasses;
    return ln(
      ...
      ln(
        ...
        t.map(function (t, e) {
          return ln(
            'li',
            { key: ''.concat(t.indexName, '-').concat(t.attribute, '-').concat(e), className: n.item },
            ln(
              'span',
              { className: n.label },
              (function (e) {
            ...
            t.refinements.map(function (e) {
              return ln(
                ...
                ln('span', { className: n.categoryLabel }, 'query' === e.attribute ? ln('q', null, e.label) : e.label),
                ln(
                  'button',
                  {
                    className: n.delete,
  ...
  var Dr = Ae({ name: 'current-refinements' }),
    Br = It('CurrentRefinements');
      ...
      ln(
        ...
        r &&
          ln(
            ...
            { className: t.control },
            a || !o
              ? ln(Qr, { classNameLabel: Ir(t.label, C({}, t.selectedLabel, a)), classNameInput: t.input, checked: a, onToggle: c }, ln(Lr, f({}, h, { templateKey: 'toggle', rootTagName: 'span' })))
              : ln(Hr, { className: t.redo, disabled: !o, onClick: u }, ln(Lr, f({}, h, { templateKey: 'redo', rootTagName: 'span' })))
          ),
        !r && !a && ln('div', { className: t.control }, ln(Hr, { className: Ir(t.redo, C({}, t.disabledRedo, !o)), disabled: !o, onClick: u }, ln(Lr, f({}, h, { templateKey: 'redo', rootTagName: 'span' })))),
        i && s && ln(Hr, { className: t.reset, onClick: l }, ln(Lr, f({}, h, { templateKey: 'reset', rootTagName: 'span' })))
      )
    );
  }
  function qr(e) {
  ...
  function Wr(e, t) {
    ...
    if (t) {
      ...
      (M.className = g.tree), F.appendChild(M), (N.mapInstance = new p.maps.Map(C, D({ mapTypeControl: !1, fullscreenControl: !1, streetViewControl: !1, clickableIcons: !1, zoomControlOptions: { position: p.maps.ControlPosition.LEFT_TOP } }, P)));
      return (
        p.maps.event.addListenerOnce(N.mapInstance, 'idle', function () {
          ...
          N.mapInstance.addListener('center_changed', e),
            ...
            N.mapInstance.addListener('idle', function () {
              N.isUserInteraction && N.isPendingRefine && ((N.isPendingRefine = !1), qr({ mapInstance: N.mapInstance, refine: a }));
            });
        }),
  ...
  var $r = { HTMLMarker: '<p>Your custom HTML Marker</p>', reset: 'Clear the map refinement', toggle: 'Search as I move the map', redo: 'Redo search here' },
    zr = Ae({ name: 'geo-search' }),
    Kr = It('GeoSearch');
  function Yr(e) {
    var t = e.className,
      n = e.handleClick,
    ...
    return ln(
      ...
      ln(Lr, f({}, a, { templateKey: s, data: o })),
      c
    );
  }
  var Jr = (function () {
    function i() {
      ...
      return (
        C(b((s = A(this, (e = E(i)).call.apply(e, [this].concat(n))))), 'state', { query: s.props.searchAsYouType ? '' : s.props.query }),
        ...
        C(b(s), 'onReset', function (e) {
          var t = s.props,
            ...
            r = t.refine,
            i = t.onReset;
          s.input.focus(), r(''), n || s.setState({ query: '' }), i(e);
        }),
        s
      );
    }
        ...
        },
        {
          ...
          value: function () {
            var t = this,
              ...
              c = e.templates,
              u = e.isSearchStalled,
              l = e.searchAsYouType ? this.props.query : this.state.query;
            return ln(
              'div',
              { className: n.root },
              ln(
                ...
                ln(Lr, { templateKey: 'submit', rootTagName: 'button', rootProps: { className: n.submit, type: 'submit', title: 'Submit the search query.', hidden: !a }, templates: c, data: { cssClasses: n } }),
                ln(Lr, { templateKey: 'reset', rootTagName: 'button', rootProps: { className: n.reset, type: 'reset', title: 'Clear the search query.', hidden: !(s && l.trim() && !u) }, templates: c, data: { cssClasses: n } }),
                o && ln(Lr, { templateKey: 'loadingIndicator', rootTagName: 'span', rootProps: { className: n.loadingIndicator, hidden: !u }, templates: c, data: { cssClasses: n } })
              )
            );
          },
        },
  ...
  C(Jr, 'defaultProps', { query: '', showSubmit: !0, showReset: !0, showLoadingIndicator: !0, autofocus: !1, searchAsYouType: !0, isSearchStalled: !1, disabled: !1, onChange: Fe, onSubmit: Fe, onReset: Fe, refine: Fe });
  var Gr = (function () {
    function c(e) {
      var t;
      ...
      T(c, [
        {
          ...
          value: function (e, t) {
            var n = this.state !== t,
              r = !ke(this.props.facetValues, e.facetValues);
            return n || r;
          },
        },
        {
          ...
          value: function (e) {
            ...
            if (r) {
              var i = this.props.cssClasses,
                a = (i.root, O(i, ['root']));
              n = ln(c, f({}, this.props, { cssClasses: a, depth: this.props.depth + 1, facetValues: e.data, showMore: !1, className: this.props.cssClasses.childList }));
            }
            var s = D({}, e, { url: this.props.createURL(e.value), attribute: this.props.attribute, cssClasses: this.props.cssClasses }),
              o = e.value;
            return (
          ...
          value: function () {
            var t = this,
              ...
              o =
                ...
                ln(Lr, f({}, this.props.templateProps, { templateKey: 'searchableNoResults', rootProps: { className: this.props.cssClasses.noResults } }));
  ...
  var Xr = {
    ...
    Zr = Ae({ name: 'hierarchical-menu' }),
    ei = It('HierarchicalMenu');
  function ti(e) {
    var t = e.results,
      n = e.hits,
      r = e.cssClasses,
    ...
    return 0 === t.hits.length
      ? ln(Lr, f({}, i, { templateKey: 'empty', rootProps: { className: Ir(r.root, r.emptyRoot) }, data: t }))
      : ln(
          'div',
          { className: r.root },
          ln(
            ...
            { className: r.list },
            n.map(function (e, t) {
              return ln(Lr, f({}, i, { templateKey: 'item', rootTagName: 'li', rootProps: { className: r.item }, key: e.objectID, data: D({}, e, { __hitIndex: t }) }));
            })
          )
        );
  }
  ...
  var ui = {
    ...
    hi = It('InfiniteHits'),
      ...
      var t = e.results,
        ...
        u = e.templateProps;
      return 0 === t.hits.length
        ? ln(Lr, f({}, u, { templateKey: 'empty', rootProps: { className: Ir(c.root, c.emptyRoot) }, data: t }))
        : ln(
            'div',
            { className: c.root },
            r && ln(Lr, f({}, u, { templateKey: 'showPreviousText', rootTagName: 'button', rootProps: { className: Ir(c.loadPrevious, C({}, c.disabledLoadPrevious, s)), disabled: s, onClick: i } })),
            ln(
              'ol',
              { className: c.list },
              n.map(function (e, t) {
                return ln(Lr, f({}, u, { templateKey: 'item', rootTagName: 'li', rootProps: { className: c.item }, key: e.objectID, data: D({}, e, { __hitIndex: t }) }));
              })
            ),
            ln(Lr, f({}, u, { templateKey: 'showMoreText', rootTagName: 'button', rootProps: { className: Ir(c.loadMore, C({}, c.disabledLoadMore, o)), disabled: o, onClick: a } }))
          );
    }),
    di = {
      item: '<a class="{{cssClasses.link}}" href="{{url}}"><span class="{{cssClasses.label}}">{{label}}</span><span class="{{cssClasses.count}}">{{#helpers.formatNumber}}{{count}}{{/helpers.formatNumber}}</span></a>',
  ...
  var gi = {
    ...
    vi = Ae({ name: 'refinement-list' }),
    yi = It('RefinementList'),
    bi = It('SearchBox');
  var Ri = { item: '<label class="{{cssClasses.label}}">\n  <input type="radio" class="{{cssClasses.radio}}" name="{{attribute}}"{{#isRefined}} checked{{/isRefined}} />\n  <span class="{{cssClasses.labelText}}">{{label}}</span>\n</label>' },
    wi = Ae({ name: 'numeric-menu' }),
    Si = It('NumericMenu');
  function Pi(e) {
    var t = e.cssClasses,
      n = e.label,
  ...
  var _i = (function () {
    function a() {
      ...
      return (
        C(b((n = A(this, (e = E(a)).call.apply(e, [this].concat(r))))), 'handleClick', function (e, t) {
      ...
      T(a, [
        {
          ...
          value: function (e) {
            ...
            var f = l && !o ? l(r) : '#';
            return ln(Pi, { ariaLabel: n, cssClasses: h, handleClick: this.handleClick, isDisabled: o, key: t + r + n, label: t, pageNumber: r, url: f });
          },
        },
        {
          ...
          value: function (e) {
            var t = e.isFirstPage,
              n = e.currentPage,
              r = e.createURL;
            return this.pageLink({ ariaLabel: 'Previous', additionalClassName: this.props.cssClasses.previousPageItem, isDisabled: 0 === this.props.nbHits || t, label: this.props.templates.previous, pageNumber: n - 1, createURL: r });
          },
        },
        {
          key: 'nextPageLink',
          value: function (e) {
            var t = e.isLastPage,
              n = e.currentPage,
              r = e.createURL;
            return this.pageLink({ ariaLabel: 'Next', additionalClassName: this.props.cssClasses.nextPageItem, isDisabled: 0 === this.props.nbHits || t, label: this.props.templates.next, pageNumber: n + 1, createURL: r });
          },
        },
        {
          key: 'firstPageLink',
          value: function (e) {
            var t = e.isFirstPage,
              n = e.createURL;
            return this.pageLink({ ariaLabel: 'First', additionalClassName: this.props.cssClasses.firstPageItem, isDisabled: 0 === this.props.nbHits || t, label: this.props.templates.first, pageNumber: 0, createURL: n });
          },
        },
        {
          key: 'lastPageLink',
          value: function (e) {
            var t = e.isLastPage,
              n = e.nbPages,
              r = e.createURL;
            return this.pageLink({ ariaLabel: 'Last', additionalClassName: this.props.cssClasses.lastPageItem, isDisabled: 0 === this.props.nbHits || t, label: this.props.templates.last, pageNumber: n - 1, createURL: r });
          },
        },
        {
          key: 'pages',
          value: function (e) {
            var t = this,
              ...
              i = e.createURL;
            return r.map(function (e) {
              return t.pageLink({ ariaLabel: e + 1, additionalClassName: t.props.cssClasses.pageItem, isSelected: e === n, label: e + 1, pageNumber: e, createURL: i });
            });
          },
        },
        {
          ...
          value: function () {
            return ln(
              'div',
              { className: Ir(this.props.cssClasses.root, C({}, this.props.cssClasses.noRefinementRoot, this.props.nbPages <= 1)) },
              ln(
                'ul',
  ...
  var xi = Ae({ name: 'pagination' }),
    Ni = It('Pagination'),
    Fi = { previous: '‹', next: '›', first: '«', last: '»' };
  var Ci = (function () {
      function t(e) {
        var n;
        return (
          k(this, t),
          C(b((n = A(this, E(t).call(this, e)))), 'onInput', function (t) {
            return function (e) {
        ...
        T(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return ln(
                'div',
                { className: Ir(o.root, C({}, o.noRefinement, !l)) },
                ln(
                  'form',
                  { className: o.form, onSubmit: this.onSubmit },
                  ln('label', { className: o.label }, ln('input', { className: Ir(o.input, o.inputMin), type: 'number', min: i, max: a, step: s, value: t, onInput: this.onInput('min'), placeholder: i, disabled: u })),
                  ln(Lr, f({}, c, { templateKey: 'separatorText', rootTagName: 'span', rootProps: { className: o.separator } })),
                  ln('label', { className: o.label }, ln('input', { className: Ir(o.input, o.inputMax), type: 'number', min: i, max: a, step: s, value: n, onInput: this.onInput('max'), placeholder: a, disabled: u })),
                  ln(Lr, f({}, c, { templateKey: 'submitText', rootTagName: 'button', rootProps: { type: 'submit', className: o.submit, disabled: u } }))
                )
              );
            },
          },
  ...
  var Yi = (function () {
    ...
    Ji = ln('div', { className: 'rheostat-background' }),
    Gi = (function () {
      function n(e) {
        var t;
        return (
          k(this, n),
          C(b((t = A(this, E(n).call(this, e)))), 'state', {
            className: $i(t.props),
          ...
          (t.getPublicState = t.getPublicState.bind(b(t))),
          (t.getSliderBoundingBox = t.getSliderBoundingBox.bind(b(t))),
          (t.getProgressStyle = t.getProgressStyle.bind(b(t))),
          (t.getMinValue = t.getMinValue.bind(b(t))),
          (t.getMaxValue = t.getMaxValue.bind(b(t))),
          (t.getHandleDimensions = t.getHandleDimensions.bind(b(t))),
          (t.getClosestSnapPoint = t.getClosestSnapPoint.bind(b(t))),
          (t.getSnapPosition = t.getSnapPosition.bind(b(t))),
          (t.getNextPositionForKey = t.getNextPositionForKey.bind(b(t))),
          (t.getNextState = t.getNextState.bind(b(t))),
          (t.handleClick = t.handleClick.bind(b(t))),
          (t.getClosestHandle = t.getClosestHandle.bind(b(t))),
          (t.setStartSlide = t.setStartSlide.bind(b(t))),
          (t.startMouseSlide = t.startMouseSlide.bind(b(t))),
          (t.startTouchSlide = t.startTouchSlide.bind(b(t))),
          (t.handleMouseSlide = t.handleMouseSlide.bind(b(t))),
          (t.handleTouchSlide = t.handleTouchSlide.bind(b(t))),
          (t.handleSlide = t.handleSlide.bind(b(t))),
          (t.endSlide = t.endSlide.bind(b(t))),
          (t.handleKeydown = t.handleKeydown.bind(b(t))),
          (t.validatePosition = t.validatePosition.bind(b(t))),
          (t.validateValues = t.validateValues.bind(b(t))),
          (t.canMove = t.canMove.bind(b(t))),
          (t.fireChangeEvent = t.fireChangeEvent.bind(b(t))),
          (t.slideTo = t.slideTo.bind(b(t))),
          (t.updateNewValues = t.updateNewValues.bind(b(t))),
          t
        );
      }
      return (
        ...
        T(n, [
          ...
          },
          {
            ...
            value: function (e) {
              var t = this.state.handlePos,
                n = t[e];
              if (0 === e) return 'vertical' === this.props.orientation ? { height: ''.concat(n, '%'), top: 0 } : { left: 0, width: ''.concat(n, '%') };
              var r = t[e - 1],
                i = n - r;
              return 'vertical' === this.props.orientation ? { height: ''.concat(i, '%'), top: ''.concat(r, '%') } : { left: ''.concat(r, '%'), width: ''.concat(i, '%') };
            },
          },
          {
            key: 'getMinValue',
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              var g =
                ...
                n);
              if (Object.prototype.hasOwnProperty.call(g, t)) (f += g[t](m)), l && (d < f ? p < u.length - 1 && (h = u[p + 1]) : 0 < p && (h = u[p - 1]));
              else if (t === Ai) (f = 0), l && (h = u[0]);
              else {
                if (t !== Ei) return null;
          ...
          },
          {
            ...
            value: function (e, t, n) {
              ...
              this.setState({ handleDimensions: this.getHandleDimensions(e, r), mousePos: { x: t, y: n }, sliderBox: r, slidingIndex: zi(e) });
            },
          },
          {
            key: 'startMouseSlide',
            value: function (e) {
              this.setStartSlide(e, e.clientX, e.clientY),
                'function' == typeof document.addEventListener
                  ? (document.addEventListener('mousemove', this.handleMouseSlide, !1), document.addEventListener('mouseup', this.endSlide, !1))
                  : (document.attachEvent('onmousemove', this.handleMouseSlide), document.attachEvent('onmouseup', this.endSlide)),
                Ki(e);
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              this.slideTo(r, a), this.canMove(r, a) && (this.setState({ x: e, y: t }), this.props.onSliderDragMove && this.props.onSliderDragMove());
            },
          },
          {
            key: 'endSlide',
            value: function () {
              ...
              if (
                ...
                'function' == typeof document.removeEventListener
                  ...
                  : (document.detachEvent('onmousemove', this.handleMouseSlide), document.detachEvent('onmouseup', this.endSlide)),
          ...
          },
          {
            ...
            value: function () {
              ...
              return ln(
                ...
                Ji,
                d.map(function (e, t) {
                  var n = 'vertical' === c ? { top: ''.concat(e, '%'), position: 'absolute' } : { left: ''.concat(e, '%'), position: 'absolute' };
                  return ln(a, {
                ...
                d.map(function (e, t, n) {
                  return 0 === t && 1 < n.length ? null : ln(l, { className: 'rheostat-progress', key: 'progress-bar-'.concat(t), style: r.getProgressStyle(t) });
                }),
                u &&
                  n.map(function (e) {
                    var t = Vi(e, o, s),
                      n = 'vertical' === c ? { top: ''.concat(t, '%'), position: 'absolute' } : { left: ''.concat(t, '%'), position: 'absolute' };
  ...
  function Xi(e) {
    ...
    return ln('div', { style: D({}, t, { marginLeft: 100 === r ? '-2px' : 0 }), className: Ir('rheostat-marker', 'rheostat-marker-horizontal', { 'rheostat-marker-large': i }) }, i && ln('div', { className: 'rheostat-value' }, s));
  }
  var Zi = (function () {
      function a() {
        var e, n;
        ...
        for (var t = arguments.length, r = new Array(t), i = 0; i < t; i++) r[i] = arguments[i];
        return (
          C(b((n = A(this, (e = E(a)).call.apply(e, [this].concat(r))))), 'handleChange', function (e) {
            var t = e.values;
          ...
          C(b(n), 'createHandleComponent', function (r) {
            return function (e) {
              ...
              return ln('div', f({}, e, { className: Ir(e.className, { 'rheostat-handle-lower': 0 === e['data-handle-key'], 'rheostat-handle-upper': 1 === e['data-handle-key'] }) }), r && ln('div', { className: 'rheostat-tooltip' }, n));
            };
          }),
          n
        );
          ...
          },
          {
            ...
            value: function () {
              var e = this.props,
                ...
                i = e.values,
                a = e.cssClasses,
                s = this.isDisabled ? { min: this.props.min, max: this.props.max + 0.001 } : this.props,
                o = s.min,
                c = s.max,
              ...
              return ln(
                'div',
                { className: Ir(a.root, C({}, a.disabledRoot, this.isDisabled)) },
                ln(Gi, { handle: this.createHandleComponent(t), onChange: this.handleChange, min: o, max: c, pitComponent: Xi, pitPoints: l, snap: !0, snapPoints: u, values: this.isDisabled ? [o, c] : i, disabled: this.isDisabled })
              );
            },
          },
          {
    ...
    ea = Ae({ name: 'range-slider' }),
    ta = It('RangeSlider');
  var na = Ae({ name: 'sort-by' }),
    ra = It('SortBy');
  var ia = {
    ...
    return ln(
      ...
      ln(
        ...
        f({}, o, {
          ...
          data: { hasManyResults: 1 < t, hasNoResults: 0 === t, hasOneResult: 1 === t, hitsPerPage: n, nbHits: t, nbPages: r, page: i, processingTimeMS: a, query: s, cssClasses: c },
        })
      )
    );
  }
  ...
  function da(e) {
    ...
    return ln(
      ...
      ln(
        ...
        ln(Lr, f({}, i, { rootTagName: 'span', rootProps: { className: r.labelText }, templateKey: 'labelText', data: t }))
      )
    );
  }
  var ma = { labelText: '{{name}}' },
    pa = Ae({ name: 'toggle-refinement' }),
    ga = It('ToggleRefinement');
  ...
  function ya(e) {
    ...
    return ln(
      'div',
      { className: Ir(i.root, C({}, i.noRefinementRoot, 0 === r.length)) },
      ln(
        'ul',
        { className: i.list },
        ln(
          'li',
          { className: Ir(i.item, C({}, i.selectedItem, 0 === r.length)) },
          ln(
            Lr,
            f({}, a, {
              templateKey: 'home',
        ...
        r.map(function (t, e) {
          ...
          return ln(
            'li',
            { key: t.label + e, className: Ir(i.item, C({}, i.selectedItem, n)) },
            ln(Lr, f({}, a, { templateKey: 'separator', rootTagName: 'span', rootProps: { className: i.separator, 'aria-hidden': !0 } })),
            n
              ? t.label
              : ln(
                  'a',
  ...
  var ba = { home: 'Home', separator: '>' },
    Ra = Ae({ name: 'breadcrumb' }),
    wa = It('Breadcrumb');
  var Sa = (function () {
      function a() {
        var e, n;
        ...
        for (var t = arguments.length, r = new Array(t), i = 0; i < t; i++) r[i] = arguments[i];
        return (
          C(b((n = A(this, (e = E(a)).call.apply(e, [this].concat(r))))), 'handleSelectChange', function (e) {
        ...
        T(a, [
          {
            ...
            value: function () {
              ...
              return ln(
                'div',
                { className: Ir(t.root, C({}, t.noRefinementRoot, 0 === r.length)) },
                ln(
                  'select',
                  { className: t.select, value: i, onChange: this.handleSelectChange },
                  ln(Lr, f({}, n, { templateKey: 'defaultOption', rootTagName: 'option', rootProps: { value: '', className: t.option } })),
                  r.map(function (e) {
                    return ln(Lr, f({}, n, { templateKey: 'item', rootTagName: 'option', rootProps: { value: e.value, className: t.option }, key: e.value, data: e }));
                  })
                )
              );
            },
    ...
    Pa = { item: '{{label}} ({{#helpers.formatNumber}}{{count}}{{/helpers.formatNumber}})', defaultOption: 'See all' },
    _a = Ae({ name: 'menu-select' }),
    xa = It('MenuSelect');
  function Na(e) {
    var t = e.url,
      n = e.theme,
    ...
    return ln(
      ...
      ln(
        'a',
        { href: t, target: '_blank', className: r.link, 'aria-label': 'Search by Algolia', rel: 'noopener noreferrer' },
        ln(
          'svg',
  ...
  var Fa = ln('path', { fill: '#5468FF', d: 'M78.99.94h16.6a2.97 2.97 0 0 1 2.96 2.96v16.6a2.97 2.97 0 0 1-2.97 2.96h-16.6a2.97 2.97 0 0 1-2.96-2.96V3.9A2.96 2.96 0 0 1 79 .94' }),
    Ca = ln('path', {
      fill: '#FFF',
    ...
    Ma = It('PoweredBy'),
    Ia = Ae({ name: 'powered-by' });
  var La = (function () {
      function a() {
        var e, t;
        k(this, a);
        for (var n = arguments.length, r = new Array(n), i = 0; i < n; i++) r[i] = arguments[i];
        return C(b((t = A(this, (e = E(a)).call.apply(e, [this].concat(r))))), 'state', { collapsed: t.props.collapsed, controlled: !1 }), t;
      }
      return (
        j(a, dn),
        T(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                return ln(
                  'div',
                  { className: Ir(r.root, ((e = {}), C(e, r.noRefinementRoot, i), C(e, r.collapsibleRoot, a), C(e, r.collapsedRoot, this.state.collapsed), e)), hidden: i },
                  s.templates.header &&
                    ln(
                      'div',
                      { className: r.header },
                      ln(Lr, f({}, s, { templateKey: 'header', rootTagName: 'span', data: o })),
                      a &&
                        ln(
                          'button',
                          {
                          ...
                          ln(Lr, f({}, s, { templateKey: 'collapseButtonText', rootTagName: 'span', data: { collapsed: this.state.collapsed } }))
                        )
                    ),
                  ln('div', {
                    className: r.body,
                  ...
                  s.templates.footer && ln(Lr, f({}, s, { templateKey: 'footer', rootProps: { className: r.footer }, data: o }))
                );
              },
            },
          ],
  ...
  function ja(e) {
    ...
    return ln(
      ...
      ln(Lr, { templateKey: 'status', rootProps: { className: t.status }, data: { status: o, errorCode: l, isListening: r, transcript: c, isSpeechFinal: u, isBrowserSupported: n }, templates: s })
    );
  }
  function Ea(e) {
    var t = e.isBrowserSupported,
      ...
      o = a.cssClasses,
      c = a.templates;
    Cn(ln(ja, { cssClasses: o, templates: c, isBrowserSupported: t, isListening: n, toggleListening: r, voiceListeningState: i }), s);
  }
  function Oa(e) {
    var t = e.cssClasses,
      n = e.templates,
  ...
  var Ha = {
    ...
    Da = Ae({ name: 'voice-search' }),
    Ba = It('VoiceSearch'),
    Qa = Ae({ name: 'query-rule-custom-data' }),
    Ua = It('QueryRuleCustomData'),
    qa = Ae({ name: 'query-rule-context' }),
    Va = Object.freeze({
      clearRefinements: function (e) {
        var t = e.container,
          n = e.templates,
        ...
        var u = ue(t),
          l = { root: Ir(Er(), c.root), button: Ir(Er({ descendantName: 'button' }), c.button), disabledButton: Ir(Er({ descendantName: 'button', modifierName: 'disabled' }), c.disabledButton) };
        return Dt(
          (function (e) {
            ...
            return function (e, t) {
              var n = e.refine,
                r = e.hasRefinements,
                i = e.instantSearchInstance;
              t ? (o.templateProps = fe({ defaultTemplates: Tr, templatesConfig: i.templatesConfig, templates: c })) : Cn(ln(kr, { refine: n, cssClasses: s, hasRefinements: r, templateProps: o.templateProps }), a);
            };
      ...
      geoSearch: function (e) {
        ...
        var _ = ue(b),
                ...
                T(u, [
                  {
                    ...
                    value: function () {
                      ...
                      (this.offset = { x: this.anchor.x + e.width / 2, y: this.anchor.y + e.height }), (this.element.style.width = ''.concat(e.width, 'px'));
                    },
                  },
                  {
                    key: 'draw',
          ...
          I = C
            ? function (e) {
                var t = e.item,
                  n = O(e, ['item']);
                return new M(D({}, C.createOptions(t), {}, n, { __id: t.objectID, position: t._geoloc, className: Ir(Kr({ descendantName: 'marker' })), template: ye({ templateKey: 'HTMLMarker', templates: N, data: t }) }));
              }
            : function (e) {
                var t = e.item,
                  n = O(e, ['item']);
        ...
        return cr(Wr, function () {
          return Cn(null, _);
        })(D({}, w, { renderState: {}, container: _, googleReference: R, initialZoom: r, initialPosition: a, templates: N, cssClasses: x, createMarker: I, markerOptions: L, enableRefine: m, enableClearMapRefinement: g, enableRefineControl: y }));
      },
      hierarchicalMenu: function () {
        ...
        return zt(
          (function (e) {
            ...
            return function (e, t) {
              ...
              t
                ? (d.templateProps = fe({ defaultTemplates: Xr, templatesConfig: a.templatesConfig, templates: f }))
                : Cn(ln(Gr, { createURL: n, cssClasses: u, facetValues: r, templateProps: d.templateProps, toggleRefinement: i, showMore: h, toggleShowMore: o, isShowingMore: s, canToggleShowMore: c }), l);
            };
          })({
            cssClasses: {
              root: Ir(ei(), p.root),
        ...
        )({ attributes: n, separator: r, rootPath: i, showParentLevel: a, limit: s, showMore: c, showMoreLimit: u, sortBy: l, transformItems: h });
      },
      hits: function (e) {
        var t = e.container,
          n = e.escapeHTML,
        ...
        var c = ue(t),
          u = { root: Ir(ii(), o.root), emptyRoot: Ir(ii({ modifierName: 'empty' }), o.emptyRoot), list: Ir(ii({ descendantName: 'list' }), o.list), item: Ir(ii({ descendantName: 'item' }), o.item) },
          l = (function (e) {
            var s = e.renderState,
              o = e.cssClasses,
              c = e.containerNode,
            ...
            return function (e, t) {
              var n = e.hits,
                ...
                i = e.instantSearchInstance,
                a = e.insights;
              t ? (s.templateProps = fe({ defaultTemplates: ni, templatesConfig: i.templatesConfig, templates: u })) : Cn(ln(ai, { cssClasses: o, hits: n, results: r, templateProps: s.templateProps, insights: a }), c);
            };
      ...
      hitsPerPage: function () {
        ...
        var s = ue(t),
          o = { root: Ir(ci(), i.root), select: Ir(ci({ descendantName: 'select' }), i.select), option: Ir(ci({ descendantName: 'option' }), i.option) };
        return kn(
          (function (e) {
            var a = e.containerNode,
              s = e.cssClasses;
            return function (e, t) {
              ...
              if (!t) {
                ...
                Cn(ln('div', { className: s.root }, ln(si, { cssClasses: s, currentValue: i, options: n, setValue: r })), a);
              }
            };
      ...
      infiniteHits: function (e) {
        ...
        var l = ue(n),
          h = {
            ...
            disabledLoadPrevious: Ir(hi({ descendantName: 'loadPrevious', modifierName: 'disabled' }), c.disabledLoadPrevious),
          ...
          f = (function (e) {
            ...
            return function (e, t) {
              var n = e.hits,
                ...
                u = e.insights;
              t
                ? (f.templateProps = fe({ defaultTemplates: ui, templatesConfig: c.templatesConfig, templates: d }))
                : Cn(ln(fi, { cssClasses: l, hits: n, results: r, hasShowPrevious: m, showPrevious: a, showMore: i, templateProps: f.templateProps, isFirstPage: s, isLastPage: o, insights: u }), h);
            };
          ...
          (function (e) {
            ...
            return function (e, t) {
              var n = e.refine,
                ...
                o = e.toggleShowMore,
                c = e.canToggleShowMore;
              if (t) f.templateProps = fe({ defaultTemplates: di, templatesConfig: a.templatesConfig, templates: d });
              else {
                var u = r.map(function (e) {
                  return D({}, e, { url: i(e.name) });
                });
                Cn(ln(Gr, { createURL: i, cssClasses: h, facetValues: u, showMore: m, templateProps: f.templateProps, toggleRefinement: n, toggleShowMore: o, isShowingMore: s, canToggleShowMore: c }), l);
              }
            };
      ...
      refinementList: function () {
        ...
        var w = !!u && Boolean(d),
          S = ue(t),
          P = (function (e) {
            var t = D({}, e, { submit: e.searchableSubmit, reset: e.searchableReset, loadingIndicator: e.searchableLoadingIndicator });
        ...
        return Yn(
          ...
          })({ containerNode: S, cssClasses: _, templates: P, renderState: {}, searchable: u, searchablePlaceholder: h, searchableIsAlwaysActive: p, showMore: s }),
          function () {
            return Cn(null, S);
          }
        )({ attribute: n, operator: r, limit: a, showMore: s, showMoreLimit: o, sortBy: i, escapeFacetValues: w, transformItems: R });
      },
          ...
          h = (function (e) {
            ...
            return function (e, t) {
              var n = e.createURL,
                ...
                i = e.refine,
                a = e.items;
              t ? (u.templateProps = fe({ defaultTemplates: Ri, templatesConfig: r.templatesConfig, templates: l })) : Cn(ln(Gr, { createURL: n, cssClasses: c, facetValues: a, templateProps: u.templateProps, toggleRefinement: i, attribute: o }), s);
            };
      ...
      pagination: function () {
        ...
        return Wn(
          ...
          })({ containerNode: y, cssClasses: w, templates: S, showFirst: u, showLast: h, showPrevious: d, showNext: p, padding: o, scrollToNode: R }),
          function () {
            return Cn(null, y);
          }
          ...
          (function (e) {
            ...
            return function (e, t) {
              ...
              if (t) p.templateProps = fe({ templatesConfig: s.templatesConfig, templates: g });
                ...
                Cn(ln(Ci, { min: o, max: c, step: f, values: { min: l !== -1 / 0 && l !== o ? l : void 0, max: h !== 1 / 0 && h !== c ? h : void 0 }, cssClasses: m, refine: n, templateProps: p.templateProps }), d);
              }
            };
          ...
          (function (e) {
            ...
            return function (e) {
              var t = e.refine,
                n = e.query,
                r = e.isSearchStalled;
              Cn(ln(Jr, { query: n, placeholder: s, autofocus: c, refine: t, searchAsYouType: u, templates: o, showSubmit: h, showReset: l, showLoadingIndicator: f, isSearchStalled: r, cssClasses: a }), i);
            };
          })({ containerNode: y, cssClasses: b, placeholder: r, templates: D({}, Li, {}, v), autofocus: o, searchAsYouType: u, showReset: h, showSubmit: d, showLoadingIndicator: p }),
          function () {
            return Cn(null, y);
          }
        )({ queryHook: g });
            ...
            return function (e, t) {
              ...
              if (!t) {
                var a = r.min,
                  ...
                  l = c === -1 / 0 ? a : c,
                  h = u === 1 / 0 ? s : u;
                Cn(ln(Zi, { cssClasses: d, refine: n, min: a, max: s, values: [s < l ? s : l, h < a ? a : h], tooltips: g, step: p, pips: m }), f);
              }
            };
      ...
      sortBy: function () {
        ...
        var s = ue(t),
          o = { root: Ir(ra(), i.root), select: Ir(ra({ descendantName: 'select' }), i.select), option: Ir(ra({ descendantName: 'option' }), i.option) };
        return Zn(
          (function (e) {
            var a = e.containerNode,
              s = e.cssClasses;
            return function (e, t) {
              var n = e.currentRefinement,
                r = e.options,
                i = e.refine;
              t || Cn(ln('div', { className: s.root }, ln(si, { cssClasses: s, currentValue: n, options: r, setValue: i })), a);
            };
          })({ containerNode: s, cssClasses: o }),
          function () {
            return Cn(null, s);
          ...
          (function (e) {
            ...
            return function (e, t) {
              var n = e.refine,
                ...
                a = e.instantSearchInstance;
              t
                ? (u.templateProps = fe({ defaultTemplates: ia, templatesConfig: a.templatesConfig, templates: c }))
                : Cn(
                    ln(
                      Gr,
                      { createURL: i, cssClasses: o, facetValues: r, templateProps: u.templateProps, toggleRefinement: n },
                      ln(
                        'svg',
                        { xmlns: 'http://www.w3.org/2000/svg', style: 'display:none;' },
                        ln('symbol', { id: sa({ descendantName: 'starSymbol' }), viewBox: '0 0 24 24' }, oa),
                        ln('symbol', { id: sa({ descendantName: 'starEmptySymbol' }), viewBox: '0 0 24 24' }, ca)
                      )
                    ),
                    s
                  );
      ...
      stats: function () {
        ...
        var s = ue(t),
          o = { root: Ir(fa(), r.root), text: Ir(fa({ descendantName: 'text' }), r.text) };
        return rr(
          (function (e) {
            ...
            return function (e, t) {
              var n = e.hitsPerPage,
                ...
                c = e.instantSearchInstance;
              t
                ? (h.templateProps = fe({ defaultTemplates: la, templatesConfig: c.templatesConfig, templates: f }))
                : Cn(ln(ua, { cssClasses: l, hitsPerPage: n, nbHits: r, nbPages: i, page: a, processingTimeMS: s, query: o, templateProps: h.templateProps }), u);
            };
      ...
      toggleRefinement: function () {
        ...
        var l = ue(t),
          h = { root: Ir(ga(), i.root), label: Ir(ga({ descendantName: 'label' }), i.label), checkbox: Ir(ga({ descendantName: 'checkbox' }), i.checkbox), labelText: Ir(ga({ descendantName: 'labelText' }), i.labelText) };
        return ar(
          (function (e) {
            var s = e.containerNode,
              o = e.cssClasses,
            ...
            return function (e, t) {
              var n = e.value,
                ...
                a = e.instantSearchInstance;
              t
                ? (c.templateProps = fe({ defaultTemplates: ma, templatesConfig: a.templatesConfig, templates: u }))
                : Cn(
                    ln(da, {
                      createURL: r,
                      cssClasses: o,
                ...
                for (var n in e)
                  if (e.hasOwnProperty(n)) {
                    ...
                    if (r.hasOwnProperty('>=') && r.hasOwnProperty('<='))
                      r['>='] && r['>='][0] === r['<='] && r['<='][0] ? t.push(''.concat(n, '=').concat(n, '_').concat(r['>='])) : t.push(''.concat(n, '=').concat(n, '_').concat(r['>='], 'to').concat(r['<=']));
          ...
          (function (e) {
            ...
            return function (e, t) {
              var n = e.canRefine,
                ...
                a = e.items,
                s = e.refine;
              t ? (u.templateProps = fe({ defaultTemplates: ba, templatesConfig: i.templatesConfig, templates: l })) : Cn(ln(ya, { canRefine: n, cssClasses: c, createURL: r, items: a, refine: s, templateProps: u.templateProps }), o);
            };
      ...
      menuSelect: function (e) {
        ...
        var f = ue(t),
          d = { root: Ir(xa(), c.root), noRefinementRoot: Ir(xa({ modifierName: 'noRefinement' }), c.noRefinementRoot), select: Ir(xa({ descendantName: 'select' }), c.select), option: Ir(xa({ descendantName: 'option' }), c.option) };
        return An(
          (function (e) {
            var s = e.containerNode,
              o = e.cssClasses,
            ...
            return function (e, t) {
              var n = e.refine,
                ...
                i = e.canRefine,
                a = e.instantSearchInstance;
              t ? (c.templateProps = fe({ defaultTemplates: Pa, templatesConfig: a.templatesConfig, templates: u })) : Cn(ln(Sa, { cssClasses: o, items: r, refine: n, templateProps: c.templateProps, canRefine: i }), s);
            };
      ...
      poweredBy: function () {
        ...
        var s = ue(t),
          o = { root: Ir(Ma(), Ma({ modifierName: 'dark' === a ? 'dark' : 'light' }), r.root), link: Ir(Ma({ descendantName: 'link' }), r.link), logo: Ir(Ma({ descendantName: 'logo' }), r.logo) };
        return hr(
          (function (e) {
            var a = e.containerNode,
              s = e.cssClasses;
          ...
          return function () {
            ...
            var t = fe({
                defaultTemplates: {
                  ...
                  collapseButtonText: function (e) {
                    var t = e.collapsed;
                    return '<svg\n          class="'
                      .concat(h.collapseIcon, '"\n          width="1em"\n          height="1em"\n          viewBox="0 0 500 500"\n        >\n        <path d="')
                      .concat(t ? 'M100 250l300-150v300z' : 'M250 400l150-300H100z', '" fill="currentColor" />\n        </svg>');
                  },
                },
                templates: r,
              }),
              a = (function (e) {
                ...
                return function (e) {
                  var t = e.options,
                    ...
                    r = e.collapsible,
                    i = e.collapsed;
                  Cn(ln(La, { cssClasses: o, hidden: n, collapsible: r, collapsed: i, templateProps: c, data: t, bodyElement: s }), a);
                };
            ...
            return D({}, s, {
              ...
              render: function () {
                ...
                var r,
                  i = t[0];
                a({ options: i, hidden: Boolean(o(i)), collapsible: u, collapsed: Boolean(l(i)) }), 'function' == typeof s.render && (r = s.render).call.apply(r, [this].concat(t));
              },
            });
          };
        };
      ...
      voiceSearch: function (e) {
        ...
        var l = ue(n),
          h = { root: Ir(Ba(), i.root), button: Ir(Ba({ descendantName: 'button' }), i.button), status: Ir(Ba({ descendantName: 'status' }), i.status) };
        return Rr(Ea, function () {
          return Cn(null, l);
        })({ container: l, cssClasses: h, templates: D({}, Ha, {}, a), searchAsYouSpeak: o, language: c, additionalQueryParameters: u });
      },
      ...
      places: function (e) {
        ...
        return {
            ...
            c.on('change', function (e) {
              ...
              c.on('clear', function () {
                (u.query = ''),
                  ...
                  1 < o.length ? s.setQueryParameter('aroundLatLngViaIP', !1).setQueryParameter('aroundLatLng', o.join(',')) : s.setQueryParameter('aroundLatLngViaIP', u.initialLatLngViaIP).setQueryParameter('aroundLatLng', void 0),
                  s.search();
              });
          },
          getWidgetState: function (e, t) {
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            return (
              (u.query = i),
              u.isInitialLatLngViaIPSet || ((u.isInitialLatLngViaIPSet = !0), (u.initialLatLngViaIP = e.aroundLatLngViaIP)),
              c.setVal(i),
              c.close(),
              e
                .setQueryParameter('insideBoundingBox', void 0)
